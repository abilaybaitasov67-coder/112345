...
const baseShooterMapBlocks: ShooterMapBlock[] = [
  ...
  { x: 180, y: 650, width: 160, height: 100, kind: 'stone', wallHeight: 4.9 },
  { x: 600, y: 1180, width: 80, height: 120, kind: 'building', wallHeight: 5.2 },
  { x: 1040, y: 900, width: 80, height: 130, kind: 'building', wallHeight: 5.8 },
  { x: 820, y: 1080, width: 80, height: 140, kind: 'stone', wallHeight: 5.1 },
  { x: 1740, y: 620, width: 60, height: 180, kind: 'stone', wallHeight: 4.7 },
  { x: 1600, y: 860, width: 60, height: 180, kind: 'building', wallHeight: 5.2 },
  { x: 780, y: 1360, width: 40, height: 100, kind: 'stone', wallHeight: 4.4 },
  { x: 1120, y: 1280, width: 40, height: 180, kind: 'stone', wallHeight: 4.8 },
  { x: 820, y: 620, width: 70, height: 80, kind: 'stone', wallHeight: 3.4 },
  { x: 1000, y: 760, width: 120, height: 60, kind: 'stone', wallHeight: 3 },
  { x: 1480, y: 380, width: 120, height: 20, kind: 'stone', wallHeight: 1.55 },
  { x: 900, y: 820, width: 100, height: 80, kind: 'cover', wallHeight: 1.3, climbable: true },
  { x: 900, y: 1380, width: 120, height: 80, kind: 'cover', wallHeight: 1.4, climbable: true },
  { x: 360, y: 240, width: 100, height: 90, kind: 'cover', wallHeight: 1.5, climbable: true },
  { x: 1450, y: 240, width: 100, height: 90, kind: 'cover', wallHeight: 1.5, climbable: true },
  { x: 250, y: 310, width: 80, height: 50, kind: 'cover', wallHeight: 1.5, climbable: true },
  { x: 530, y: 150, width: 70, height: 80, kind: 'cover', wallHeight: 1.5, climbable: true },
  { x: 1320, y: 620, width: 70, height: 70, kind: 'cover', wallHeight: 1.5, climbable: true },
  { x: 1600, y: 320, width: 90, height: 60, kind: 'cover', wallHeight: 1.5, climbable: true },
  { x: 1400, y: 1140, width: 80, height: 70, kind: 'cover', wallHeight: 1.5, climbable: true },
