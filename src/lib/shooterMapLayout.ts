...
const baseShooterMapBlocks: ShooterMapBlock[] = [
  ...
  { x: 250, y: 310, width: 80, height: 50, kind: 'cover', wallHeight: 1.5 },
  { x: 530, y: 150, width: 70, height: 80, kind: 'cover', wallHeight: 1.5 },
  { x: 1320, y: 620, width: 70, height: 70, kind: 'cover', wallHeight: 1.5 },
  { x: 1600, y: 320, width: 90, height: 60, kind: 'cover', wallHeight: 1.5 },
  { x: 1400, y: 1140, width: 80, height: 70, kind: 'cover', wallHeight: 1.5 },
